...
#if defined(CONFIG_PROJECT_V3702_CLF_PH)
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Thrill HD",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "BQS-5020 Strike",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "QMobile i6 Metal HD",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "QMobile S2 Plus",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "QMobile S2 Pro",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Dash X2",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Micromax Q350",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Micromax Q352",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "P4200AN",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "ADVANCE 4.0 L2",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Ilium X510",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Mobicel Candy",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Mobicel FRIO",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "SUNNY",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "Oysters PacificE",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "EverStar Pro",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "EverStar Nano",
	{  },	/* end of list */
};
...
static struct usb_string mtp_string_defs[] = {
	/* Naming interface "MTP" so libmtp will recognize us */
	[INTERFACE_STRING_INDEX].s	= "LENNY3 MAX",
	{  },	/* end of list */
};
...
static void reset_mtp_string_wiko(void){
    ...
    if((!strncmp(Market_Area, "DU", strlen("DU"))) 
        || (!strncmp(Market_Area, "ID", strlen("ID"))) 
        || (!strncmp(Market_Area, "VN", strlen("VN"))))
    {
        mtp_string_defs[INTERFACE_STRING_INDEX].s = "B-KOOL";
    }
    else
    {//EU TH
        mtp_string_defs[INTERFACE_STRING_INDEX].s = "SUNNY";
    }
#elif defined(CONFIG_PROJECT_V3750_WIK_FR)
    if((!strncmp(Market_Area, "DU", strlen("DU"))) 
        || (!strncmp(Market_Area, "VN", strlen("VN"))) 
    ...
    {
        mtp_string_defs[INTERFACE_STRING_INDEX].s = "ROBBY";
    }
    else
    {
        mtp_string_defs[INTERFACE_STRING_INDEX].s = "ROBBY";
