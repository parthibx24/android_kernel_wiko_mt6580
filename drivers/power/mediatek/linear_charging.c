...
printk("[yixuhong] BMT_status.charger_type =%d \n",BMT_status.charger_type);
		...
		if (BMT_status.charger_type == STANDARD_HOST) {
		  ...
		  printk("[yixuhong] NONSTANDARD_CHARGER charger cc mode g_temp_standar_charger_value =%d \n",g_temp_standar_charger_value);
		  ...
		  if(g_temp_standar_charger_value > TINNO_NON_STD_AC_CHARGER_CURRENT)
			...
			printk("[yixuhong] NONSTANDARD_CHARGER charger cc mode g_temp_CC_value =%d \n",g_temp_CC_value);
       ...
       //yixuhong 20151116 add for test

			printk("[yixuhong] STANDARD_CHARGER charger cc mode g_temp_standar_charger_value =%d \n",g_temp_standar_charger_value);
			...
			printk("[yixuhong] STANDARD_CHARGER charger cc mode g_temp_CC_value =%d \n",g_temp_CC_value);
     ...
     g_temp_CC_value = batt_cust_data.ac_charger_current;
        ...
        else if (BMT_status.charger_type == TINNO_1_5A_CHARGER) 
        {
			...
			printk("[yixuhong] TINNO_1_5A_CHARGER charger cc mode g_temp_standar_charger_value =%d \n",g_temp_standar_charger_value);
			...
			printk("[yixuhong] TINNO_1_5A_CHARGER charger cc mode g_temp_CC_value =%d \n",g_temp_CC_value);
			
		printk("[yixuhong] TINNO_1_5A_CHARGER charger cc mode batt_cust_data.tinno_1_5a_charger_current =%d \n",batt_cust_data.tinno_1_5a_charger_current);
...
static void pchr_turn_on_charging(void)
{
	...
	if (BMT_status.bat_charging_state == CHR_ERROR) {
...
#if defined(CONFIG_TINNO_QUICK_CHARGING) 
		battery_xlog_printk(BAT_LOG_CRTI, "pchr_turn_on_charging maxPgFlag=%d\r\n",maxPgFlag);
		...
		{
			battery_xlog_printk(BAT_LOG_CRTI, "pchr_turn_on_charging maxPgFlag11111=%d\r\n",maxPgFlag);
			select_charging_curret();		
			battery_charging_control(CHARGING_CMD_SET_CURRENT,&g_temp_CC_value);
		}
#else
