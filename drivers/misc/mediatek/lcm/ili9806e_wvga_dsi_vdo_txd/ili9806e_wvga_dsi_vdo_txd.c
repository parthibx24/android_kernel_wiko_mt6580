...
{0x31,1,{0x02}},// C Inversion
{0x40,1,{0x10}},// BT 				 
{0x41,1,{0x33}},// DVDDH DVDDL clamp 
{0x42,1,{0x02}},// VGH/VGL 
{0x43,1,{0x09}},// VGH/VGL  
{0x44,1,{0x03}},// VGL_CLAMP OFF 
{0x45,1,{0x05}},// LOW DETEC 
{0x48,1,{0x30}},// VCOM SET NVM OR REG		     
...
static unsigned int rgk_lcm_compare_id(void)
{
    ...
    {
    #ifdef BUILD_LK
    printf("[adc_uboot txd]: get data error\n");
   #else
	 printk("[adc_uboot txd]: get data error\n");
  #endif
    return 0;
    ...
    #ifdef BUILD_LK
     printf("[adc_uboot txd]: lcm_vol= %d\n",lcm_vol);
   #else
     printk("[adc_uboot txd]: lcm_vol= %d\n",lcm_vol);
  #endif
...
LCM_DRIVER ili9806e_wvga_dsi_vdo_txd_lcm_drv = 
{
