...
static unsigned int rgk_lcm_compare_id(void)
{
	...
	id = (id_high<<8) | id_low;
	#ifdef BUILD_LK
	printf("read buffer0=0x%x, buffer1=0x%x, buffer2=0x%x, buffer3=0x%x",buffer[0], buffer[1],buffer[2],buffer[3]);
	printf("%s:read id=0x%x, id1=0x%x, id2=0x%x",__func__,id, id_high,id_low);
        #endif
#if 1
