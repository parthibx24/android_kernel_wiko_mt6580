...
static LCM_setting_table_V3 lcm_initialization_setting[] = {
		...
		{0x39,0xBA,6,{0x62,0x03,0x68,0x6B,0xB2,0xC0}},    //0x7B-->0x5F  
		{0x39,0xB1,10,{0x48,0x11,0x71,0x09,0x32,0x44,0x71,0x31,0x4F,0x35}},
		{0x39,0xB2,5,{0x60,0x80,0x64,0x05,0x07}},
		{0x39,0xB4,22,{0x26,0x76,0x26,0x76,0x26,0x26,0x05,0x10,0x86,0x75,0x00,0x3F,0x26,0x76,0x26,0x76,0x26,0x26,0x05,0x10,0x86,0x3F}},
		{0x39,0xD3,33,{0x00,0x00,0x04,0x04,0x01,0x01,0x10,0x10,0x32,0x10,0x00,0x00,0x00,0x32,0x15,0x04,0x05,0x04,0x32,0x15,0x14,0x05,0x14,0x37,0x33,0x04,0x04,0x37,0x00,0x00,0x47,0x05,0x40}},
		...
		{0x39,0xE0,58,{0x01,0x0b,0x15,0x1c,0x1f,0x23,0x26,0x27,0x50,0x63,0x72,0x72,0x7d,0x93,0x91,0x96,0xa4,0xa5,0x9d,0xAc,0xBc,0x5d,0x5d,0x62,0x67,0x6b,0x70,0x7f,0x7F,0x01,0x0b,0x15,0x1c,0x1f,0x23,0x26,0x27,0x50,0x63,0x72,0x72,0x7d,0x93,0x91,0x96,0xa4,0xa5,0x9d,0xAc,0xBc,0x5d,0x5d,0x62,0x67,0x6b,0x70,0x7f,0x7F}},
		{0x15,0xCC,1,{0x0b}},
		...
		{0x15,0xB1,1,{0X00}},
		{0x15,0xBD,1,{0X00}},
		{0x39,0xBF,7,{0x40,0x81,0x50,0x00,0x1A,0xFC,0x01}},// 7TH 01-->0C
		{0x15,0xbc,1,{0x07}}, // 3
		{0x15,0x35,1,{0x00}}, // 35 off te
	        {0x15, 0x11,1,{0x00}},
	        {REGFLAG_ESCAPE_ID,REGFLAG_DELAY_MS_V3, 120, {}},
                {0x39,0xB2,13,{0x60,0x80,0x64,0x05,0x07,0x2F,0x00,0x00,0x00,0x00,0xC0,0x18,0x50}},
	        {0x15, 0x29,1,{0x00}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.lcm_esd_check_table[1].para_list[2] = 0x06;// two  
    params->dsi.lcm_esd_check_table[1].para_list[3] = 0x00;// two 
...
LCM_DRIVER hx8394f_v3800_dsi_vdo_3lanes_tcl_lcm_drv =
{
        .name            = "hx8394f_v3800_dsi_vdo_3lanes_tcl",
