...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		.pclk = 275200000,				//record different mode's pclk
		.linelength = 3744,				//record different mode's linelength
//		.framelength =2498, //3168,			//record different mode's framelength
		.framelength =3063, //3168,			//record different mode's framelength //全景需走zsdcc,帧率要降低到24fps.wupingzhou,20160201.
...
static void preview_setting(void)
{
  ...
  write_cmos_sensor(0x0306, 0x00AC);
