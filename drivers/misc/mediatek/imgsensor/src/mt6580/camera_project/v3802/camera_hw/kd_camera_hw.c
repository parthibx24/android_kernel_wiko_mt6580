...
#define VOL_1000 1000000
	...
	if (On) {
		...
		PK_DBG("[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
            ...
            if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI553_MIPI_RAW_5MP, currSensorName)))
            {
    			/* VCAM_IO */
			...
			mdelay(50);
				...
				{
				 if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP, currSensorName)))
		...
		if((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_CMK, currSensorName)))
			...
			if (TRUE != _hwPowerDown(VCAMD)) {
				...
				{
				 if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI553_MIPI_RAW_5MP, currSensorName)))
				||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP, currSensorName)))
