...
#define RGr_ratio_Typical  592	//modify by v3702 
#define BGr_ratio_Typical  581  //modify by v3702
...
void Darling_S5K4H8_read_OTP(void)
{
   ...
   a = (a26+a27+a28+a29+a30+a31+a32+a33+a34+a35+a36+a37+a38+a39)%0xff+1;
	...
	{
		flag_otp += 0x04;
      otp_4h8_id_data[5]=S5K4H8_byteread_cmos_sensor(0x0A19);
	  otp_4h8_id_data[6]=S5K4H8_byteread_cmos_sensor(0x0A18);
	  otp_4h8_id_data[7]=S5K4H8_byteread_cmos_sensor(0x0A17);
	  otp_4h8_id_data[8]=S5K4H8_byteread_cmos_sensor(0x0A16);

		SENSORDB_S5K4H8_OTP("S5K4H8 S5K4H8_byteread_cmos_sensor(0x0A18)= 0x%x, S5K4H8_byteread_cmos_sensor(0x0A19) = 0x%x\n",S5K4H8_byteread_cmos_sensor(0x0A18),S5K4H8_byteread_cmos_sensor(0x0A19));
		SENSORDB_S5K4H8_OTP("S5K4H8 S5K4H8_byteread_cmos_sensor(0x0A16)= 0x%x, S5K4H8_byteread_cmos_sensor(0x0A17) = 0x%x\n",S5K4H8_byteread_cmos_sensor(0x0A16),S5K4H8_byteread_cmos_sensor(0x0A17));
	...
	{
		flag_otp += 0x04;
	  otp_4h8_id_data[5]=S5K4H8_byteread_cmos_sensor(0x0A39);
	  otp_4h8_id_data[6]=S5K4H8_byteread_cmos_sensor(0x0A38);
	  otp_4h8_id_data[7]=S5K4H8_byteread_cmos_sensor(0x0A37);
	  otp_4h8_id_data[8]=S5K4H8_byteread_cmos_sensor(0x0A36);
...
{    
	...
	otp_4h8_id_data[0]= 0x10;
	otp_4h8_id_data[1]= 0xff;
	otp_4h8_id_data[2]= 0x00;
	otp_4h8_id_data[3]= 0x40;
	otp_4h8_id_data[4]= 0x88;
	otp_4h8_af_data[0]=(otp_4h8_id_data[6]<<8 )|otp_4h8_id_data[5];
	otp_4h8_af_data[1]=(otp_4h8_id_data[8]<<8 )|otp_4h8_id_data[7];
if(size ==2 ){
	if(offset == 17){
