...
extern void receiverSwitch(int n);
extern void speakerSwitch(int n);
extern void micSwitch(int n);
/******************************************************************************
 * configuration
*******************************************************************************/
...
static ssize_t show_receiverSwitch(struct device_driver *ddri, char *buf)
{
	return 0;     
}

static ssize_t store_receiverSwitch(struct device_driver *ddri, char *buf, size_t count)
{
    int enable;
	sscanf(buf, "%d", &enable);
    receiverSwitch(enable);
	printk("The value of enable is %d\n",enable); 
    return count;
}

static ssize_t show_speakerSwitch(struct device_driver *ddri, char *buf)
{
	return 0;     
}

static ssize_t store_speakerSwitch(struct device_driver *ddri, char *buf, size_t count)
{
    int enable;
	sscanf(buf, "%d", &enable);
    speakerSwitch(enable);
	printk("The value of AudioChannel is %d\n",AudioChannel); 
    return count;
}

static ssize_t show_micSwitch(struct device_driver *ddri, char *buf)
{
	return 0;     
}

static ssize_t store_micSwitch(struct device_driver *ddri, char *buf, size_t count)
{
    int enable;
	sscanf(buf, "%d", &enable);
    micSwitch(enable);
...
static DRIVER_ATTR(receiverSwitch,   0664, show_receiverSwitch, store_receiverSwitch);
static DRIVER_ATTR(speakerSwitch,     0664, show_speakerSwitch, store_speakerSwitch); //guomingyi 20140812 add for cat ps chip info
static DRIVER_ATTR(micSwitch,     0664, show_micSwitch, store_micSwitch); //guomingyi 20140812 add for cat ps chip info
...
static struct device_attribute *ltr553_sub_attr_list[] =
{
    ...
    &driver_attr_receiverSwitch,
    &driver_attr_speakerSwitch,
    &driver_attr_micSwitch,
};
/*----------------------------------------------------------------------------*/
